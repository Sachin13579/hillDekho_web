                            ...
                            <div>
                                ...
                                <div className="w-full mt-5">
                                    ...
                                    <div className="flex justify-between">
                                        <p className={`${playFairDisplay.className} text-black md:text-sm lg:text-base text-transform: uppercase font-extrabold pt-0 `}>
