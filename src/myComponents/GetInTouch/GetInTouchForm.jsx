...
const GetInTouchForm = () => {
    return (
        ...
        <main className="flex justify-center items-center flex-col">
            ...
            <section
                className="relative z-10 overflow-hidden bg-white dark:bg-dark py-20 "
            >
                <div className="container mx-auto">
                    <div className="flex flex-wrap  -mx-4 justify-space-between">
                        <div className="w-full  px-4 lg:w-1/2 xl:w-6/12">
                            <div className="mb-12 max-w-[570px] lg:mb-0">
                                <span className="sm:text-xs lg:text-base leading-6 tracking-widest text-Aquamarine700">
                                    Contact Us
                                </span>
                                <h2
                                    className={`${playFairDisplay.className} text-dark dark:text-white mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]`}
                                >
                                ...
                                >
                                    Ready to plan your dream getaway? Our dedicated team is here to turn your travel aspirations into reality. Contact us today for personalised itineraries, unbeatable deals, and unforgettable journeys!
                                </p>
                        ...
                        <div className="w-full px-4 lg:w-1/2 ">
                            {/* <div className="w-full border-red-400 border-2 px-4 lg:w-1/2 xl:w-5/12"> */}
                            <div
                            ...
                            >
                                <form>
                                    ...
                                    <div>
                                        <button
                                            type="submit"
                                            className=" w-full rounded-md bg-teal-400  px-8 py-3 font-medium text-white transition hover:bg-teal-800"
