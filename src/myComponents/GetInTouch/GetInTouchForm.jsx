...
const GetInTouchForm = () => {
  return (
    <main className="flex justify-center items-center flex-col">
      <section className="relative z-10 overflow-hidden bg-white dark:bg-dark py-20 ">
            ...
            <div className="w-full  px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="text-base leading-relaxed text-body-color dark:text-dark-6 mb-9">
                  Ready to plan your dream getaway? Our dedicated team is here
                  to turn your travel aspirations into reality. Contact us today
                  for personalised itineraries, unbeatable deals, and
